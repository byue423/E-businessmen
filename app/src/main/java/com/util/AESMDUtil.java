...
public class AESMDUtil {
	/**
	 * @功 能：AES 加解密
	 * @创建者：wjj 创建日期： 2016年3月23日 上午10:43:20 @return：
	 */

	/* 密钥*/
	private static final String mdKey = "sdkj";
	...
	public static String encrypt(byte[] content) {
		try {
			SecretKey secretKey = getKey(mdKey);
